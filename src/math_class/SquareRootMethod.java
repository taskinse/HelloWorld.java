...
public class SquareRootMethod {
    public static void main(String[] args) {
        ...
        System.out.println("Roots of number is " +Math.sqrt(number));
        System.out.println("Roots of number2  is " +Math.sqrt(number2));
        System.out.println("Roots of number3 is " +Math.sqrt(number3));
