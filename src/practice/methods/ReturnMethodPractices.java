...
99, 23 -> 76
   ...
   public static int findDifference(int num1,int num2){
    ...
    /*Create a public static method named as "findDifference" it will take two decimal values and returns the difference
    Example:
            6, 9 -> 3
            4, 1 -> 3
            99, 23 -> 76
...
"John", "blue" -> false
    ...
    public static boolean isIncluded(String str1, String str2){
       ...
       // return str1.contains(str2) || str2.contains(str1); another option
